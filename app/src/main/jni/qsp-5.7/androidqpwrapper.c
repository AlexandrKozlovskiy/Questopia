...
///* Показ / скрытие окон */
void
Java_org_qp_android_model_libQP_NativeMethods_QSPShowWindow(JNIEnv *env, jobject this, jint type,
															jboolean isShow) {
...
jboolean Java_org_qp_android_model_libQP_NativeMethods_QSPLoadGameWorld(JNIEnv *env, jobject this,
																		jstring fileName) {
...
jboolean
Java_org_qp_android_model_libQP_NativeMethods_QSPLoadGameWorldFromData(JNIEnv *env, jobject this,
																	   jbyteArray data,
																	   jint dataSize,
																	   jstring fileName) {
  //converting data
...
jboolean Java_org_qp_android_model_libQP_NativeMethods_QSPSaveGame(JNIEnv *env, jobject this,
																   jstring fileName,
																   jboolean isRefresh) {
  const char *str = (*env)->GetStringUTFChars(env, fileName, NULL);
  if (str == NULL)
